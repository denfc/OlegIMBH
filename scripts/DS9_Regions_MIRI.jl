...
26 October 2024
	- 13 November 2024
	- Miri version with 200W replaced by 770W and and 444W replaced by 1500W, i.e., extremely lazy!
	- The rest of the script is the same as the original.
		- The next version should have NIRCAM and MIRI as choices, with the two couples of wavelength values put in, but for now ...
...
# 16. Instrumental VEGAMAG magnitude, MIRI_770W
# 29. Instrumental VEGAMAG magnitude, MIRI_F1500W
...
bright_Q770_flag = df.Column24[bright_ind]
bright_Q1500_flag = df.Column37[bright_ind]
...
bright_good_ind = findall(i -> bright_SNR[i] >= limits["SNR"] &&
                               ...
                               bright_Q770_flag[i] <= limits["Q770_flag"] &&
                               bright_Q1500_flag[i] <= limits["Q1500_flag"], eachindex(bright_ind))
...
regFile_1 = DS9_writeRegionFile(selected_16_Xvalues, selected_16_Yvalues, 29, "F770"; color = "green")
regFile_2 = DS9_writeRegionFile(selected_29_Xvalues, selected_29_Yvalues, 25, "F1500"; color = "red")
...
# regFile_test = "/home/dfc123/Gitted/OlegIMBH/data/sims/F1500_save.reg"
