function load_zoom_grid_color_scale_view(file; z = "zoom to fit", g = "grid yes", c = "cmap scm_greyC", s = "scale ASINH", v = "view vertical", level = "99.5", a = "align yes") # , s = "scale pow"
